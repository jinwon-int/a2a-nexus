...
| `cross-broker-handoff` | Cross-broker handoff protocol | `contracts/a2a/broker-handoff-protocol.md`, `fixtures/contract/broker-beta-cross-broker-handoff.json` | tck-gate | `node test/conformance/check-contract-fixtures.mjs` |
