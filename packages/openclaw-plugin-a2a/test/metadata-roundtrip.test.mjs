  ...
  const status = buildGatewayTaskStatus({
    ...
    payload: {
      taskInput: {
        ...
        commitSha: 'abc123',
        round: '2026-05-01',
        prUrl: 'https://github.com/jinwon-int/plugin-a2a/pull/129',
        doneUrl: 'https://github.com/jinwon-int/plugin-a2a/issues/129#issuecomment-1',
        blockUrl: 'https://github.com/jinwon-int/plugin-a2a/issues/129#issuecomment-2',
        artifactUrl: 'https://github.com/jinwon-int/plugin-a2a/actions/runs/1',
