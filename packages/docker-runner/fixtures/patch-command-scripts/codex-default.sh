...
A2A_CODEX_DEFAULT_MODEL='gpt-5.6-sol'
A2A_CODEX_DEFAULT_REASONING_EFFORT='high'
A2A_CODEX_DEFAULT_TIMEOUT_SEC='3600'
...
Contained subagents:
- Do not spawn Codex subagents for this task. This runner keeps subagent fanout disabled unless the host explicitly opts in.
