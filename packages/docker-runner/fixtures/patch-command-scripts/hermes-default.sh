...
Contained subagents:
- You may spawn up to 3 Hermes subagent(s) inside this same Docker task boundary when the assignment matches these reasons: context_heavy, broad_source_inspection, validation_split.
- Allowed helper roles: explorer, verifier.
