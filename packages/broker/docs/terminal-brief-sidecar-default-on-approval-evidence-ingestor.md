...
npm run terminal_brief -- terminal_brief_sidecar_default_on_approval_evidence_ingestor --input fixtures/terminal-brief/sidecar-default-on-approval-evidence-ingestor.no-live.json --json
