...
npm run terminal_brief -- terminal_brief_sidecar_default_on_runtime_executor_gate --input fixtures/terminal-brief/sidecar-default-on-runtime-executor-gate.no-live.json --json
