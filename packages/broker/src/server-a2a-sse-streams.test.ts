...
test("stale reaper no-op sweeps do not publish expensive operator summary updates", async () => {
  const server = await startTestServer({
    edgeSecret: "test-edge-secret",
