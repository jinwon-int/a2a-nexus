...
export const SHARED_STATE_STORAGE_V1_VALUES = deepFreeze({
  versions: {
    ...
    outbox: "a2a.shared-state.outbox/v1",
    metadata: 1,
    capabilities: 1,
    lifecycle: 1,
    openRequirements: 1,
  ...
  digestDomains: {
    ...
    "broker.outbox.stream-key": {
      ...
      operationFields: [
        ...
        "updateOutboxReceipt.input.streamKeyDigest",
        "acknowledgeOutbox.input.streamKeyDigest",
      ],
    },
  ...
  parserErrorCodes: [
    ...
    "unknown_outbox_event_purpose",
    "invalid_outbox_stream_key",
    "outbox_stream_key_shape_mismatch",
    "outbox_stream_key_component_mismatch",
    "invalid_outbox_stream_key_component",
    "outbox_stream_key_digest_mismatch",
    "outbox_ordering_scope_mismatch",
    ...
    "outbox_receipt_transition_mismatch",
    "outbox_acknowledgment_forbidden",
    "outbox_provider_acceptance_not_ack",
    "outbox_acknowledgment_evidence_mismatch",
  ],
  limits: {
