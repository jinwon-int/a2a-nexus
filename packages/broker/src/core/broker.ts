...
export {
  ...
  DEFAULT_MAX_TERMINAL_TASK_BYTES,
...
export class InMemoryA2ABroker {
  ...
  // 14-16 attach only explicit create, cancel, and signed-reviewer report
  // sources whose durable source row and normalized Phase 8 command share one
  // transaction.
