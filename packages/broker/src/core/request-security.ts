...
export interface A2AHttpSignatureVerifyOptions {
   ...
   * window keeps the replay surface bounded, and nonce reuse is rejected after
   * verification by the broker's A2AHttpSignatureReplayCache. Default 0 (strict,
...
// ---------------------------------------------------------------------------
// Minimum-scope peer broker credentials for the cross-broker handoff surface
// ---------------------------------------------------------------------------

/**
 * ## Peer broker credentials (formerly peer-credentials.ts, folded here
 * per the broker core module budget, a2a-nexus#882) — Minimum-scope peer broker credentials for the
...
// (peer header extraction reuses the module-level `headerValue` helper above)
