...
} from "../dist/core/orchestration-intelligence-worker-spawn-approval-request.js";
...
async function main() {
  ...
  else console.log(renderOIWorkerSpawnApprovalRequestMarkdown(packet));
}

main().catch((error) => {
  console.error(
    "orchestration-intelligence-worker-spawn-approval-request: "
