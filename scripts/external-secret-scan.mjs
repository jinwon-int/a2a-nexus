...
const EXACT_SYNTHETIC_FIXTURE_FILES = new Set([
  ...
  'packages/broker/src/core/broker-conversation.test.ts',
  'packages/broker/dist/core/broker-conversation.test.js',
  'packages/broker/src/core/handler-failure-class.test.ts',
  'packages/broker/dist/core/handler-failure-class.test.js',
