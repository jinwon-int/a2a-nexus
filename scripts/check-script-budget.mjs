...
export const BUDGETS = {
  ...
  rootNpmScripts: 82, // -1 from 83: check:historical selected zero steps once split-repo-local-demo and current-state-no-live-smoke moved to core. An alias that runs nothing is worse than no alias — it reads like coverage.
