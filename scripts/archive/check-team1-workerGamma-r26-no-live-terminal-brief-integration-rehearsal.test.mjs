...
const docPath = join(
  ...
  'docs',
  'validation',
  'team1-workerGamma-r26-no-live-terminal-brief-integration-rehearsal.md',
);
...
test('R26 rehearsal doc references R25 merged artifacts', async () => {
  ...
  assertIncludesAll(content, [
    ...
    'team1-workerGamma-r25-ops-readiness-terminal-brief.md',
...
test('R26 rehearsal doc includes safety boundary, verification commands, and evidence packet schema', async () => {
  ...
  assertIncludesAll(content, [
    ...
    'check-team1-workerGamma-r26-no-live-terminal-brief-integration-rehearsal.test.mjs',
    'check-team1-workerGamma-r25-ops-readiness-terminal-brief.test.mjs',
