...
const docPath = join(
  ...
  'docs',
  'validation',
  'team2-workerEta-r16-terminal-brief-libero.md',
);
...
test('R16 libero validation binds issue, parent, run, lane, and safe no-live scope', async () => {
  ...
  assertIncludesAll(content, [
    'a2a-plane#316',
    'a2a-broker#631',
    'r16-terminal-brief-libero-workerEta-20260514T0937Z',
...
test('R16 lane snapshot lists all workers and treats start-only evidence as waiting', async () => {
  ...
  assertIncludesAll(content, [
    '`workerEpsilon` | [openclaw-plugin-a2a#313]',
    '`workerZeta` | [a2a-broker#632]',
    '`workerEta` | a2a-plane#316',
