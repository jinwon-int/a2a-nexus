...
test('Team1/yukson live activation checklist binds issue, run, and broker', async () => {
  ...
  assert.match(content, /seoseo remains Team1 broker\/finalizer of record/i);
});

test('Team1/yukson live activation checklist documents prerequisite documents', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist covers all required approval gate categories', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist covers broker Docker-only deploy revision', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist covers Gateway plugin-level wiring', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist covers one bounded canary task', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist covers rollback/no-op behavior', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist covers accepted-send vs read/visibility/Terminal ACK separation', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist covers explicit approval gates', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist states deploy/restart/live send/ACK/DB/release/credential need fresh operator approval', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist documents risk notes and approval-sensitive blockers', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist is no-live and fail-closed', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist documents runtime/bootstrap hygiene', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist includes verification output section', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist includes changed files section', async () => {
  const content = await doc();
...
test('Team1/yukson live activation checklist includes closeout evidence section', async () => {
  const content = await doc();
