...
const docPath = join(
  ...
  'docs',
  'validation',
  'team2-workerEta-r15-structured-terminal-brief-libero.md',
);
...
test('R15 lane snapshot lists all seven workers and sibling issue links', async () => {
  ...
  assertIncludesAll(content, [
    '1/7 | `workerGamma` | [a2a-broker#624]',
    '2/7 | `workerBeta` | [openclaw-plugin-a2a#311]',
    '3/7 | `workerAlpha` | [a2a-broker#627]',
    '4/7 | `workerDelta` | a2a-plane#311',
    '5/7 | `workerEpsilon` | [a2a-broker#625]',
    '6/7 | `workerZeta` | [a2a-docker-runner#255]',
    '7/7 | `workerEta` | a2a-plane#312',
