...
const docPath = join(repoRoot, 'docs', 'validation', 'team1-workerDelta-plane-gates-527-497-294-r22-lightweight.md');
...
test('R22 lightweight doc references existing gate packet without replacement', async () => {
  ...
  assert.match(content, /team1-workerDelta-plane-gates-527-497-294\.md/);
...
test('R22 lightweight doc cross-checks all three team1 sibling roadmap inputs', async () => {
  ...
  for (const worker of ['workerGamma', 'workerAlpha', 'workerBeta']) {
