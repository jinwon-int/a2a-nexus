...
- [A2A current state](docs/current-state.md) - a2a-broker #1320/#1321 mode research, completed #506/#511/#513/#514/#515/#517 monorepo phase 0 groundwork, ownership boundaries, and checkout hygiene.
...
- [A2A monorepo branch/release policy](docs/monorepo-branch-release-policy.md) - branch protection, tag, release, and package publishing gates.
...
See [`docs/current-state.md`](docs/current-state.md) for the live issue index and completed #506/#511/#513/#514/#515/#517 groundwork.
...
Current public umbrella trackers are closed for monorepo phase 0 planning. New
work should start from the completed policy docs below or from the broker mode
research issues.
...
- [#517](https://github.com/jinwon-int/a2a-plane/issues/517) — branch protection and release/package policy. Policy recorded in [`docs/monorepo-branch-release-policy.md`](docs/monorepo-branch-release-policy.md).
