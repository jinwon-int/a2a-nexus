...
- `wave-plan-dag-v2.json` — source-only P2-C golden vectors for a closed digest-bound DAG proposal, ASCII-stable topological order, conditional gate branches and joins, and deterministic read-only dry-run receipts with no execution authority.
