# Analysis: mobile-alpha Hermes Lightweight A2A Worker Profile
...
Before this spec, mobile-alpha had no documented operating mode:

- mobile-alpha was an Android Termux node with OpenClaw retired; the device's capabilities and restrictions were not written down.
...
1. Defining the mobile-alpha/Hermes lightweight worker identity.
...
- production mobile-alpha worker registration
