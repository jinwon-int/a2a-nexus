...
| L5 | **Public beta readiness decision packet.** Produce the final pre-visibility-change evidence packet that an operator can review in under 15 minutes and issue a single explicit approval comment. | The last packet before the operator says GO. |
