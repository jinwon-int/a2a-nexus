...
- PR-safe closeout evidence for #1172, #1173, and #1174 is recorded in [Public externalization follow-up closeout evidence](history/public-externalization-followups.md). #1160 remains the external listing tracker until directory PRs reach final outcomes.
