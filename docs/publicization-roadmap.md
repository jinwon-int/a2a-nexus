...
| Feedback/notification readiness | Public issue forms and PR template route public-safe feedback; external watcher operation is tracked outside this repo. | Confirm any live notification path without sending canary/provider messages unless separately approved. | Live provider/Telegram sends or broad announcement. |
