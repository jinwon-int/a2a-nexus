...
> **Status:** Re-entry decision recorded by a2a-plane#511 (a2a-plane#511, internal tracker private); branch/release/package policy recorded by #517 (a2a-plane#517, internal tracker private) and phase-2 rehearsal evidence by #530 (a2a-plane#530, internal tracker private)
> **Decision:** proceed with a staged umbrella workspace rehearsal, not an immediate canonical monorepo flip.

## Summary

the operator re-opened the monorepo question after the
`a2a-plane#506` (a2a-plane#506, internal tracker private) current-state
...
The previous topology decision, #473 (a2a-plane#473, internal tracker private),
...
| Branch protection | `a2a-plane/main` protection is reviewed before any canonical flip. | Policy documented by `#517`; settings changes not approved |
| Release/package policy | npm/GitHub Packages, tags, images, and CLI canonical names are decided. | Policy documented by `#517`; publish/release remains NO-GO |
